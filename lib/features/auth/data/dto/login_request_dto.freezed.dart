...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginRequestDto&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.smsCode, smsCode) || other.smsCode == smsCode));
}
...
@override
String toString() {
  return 'LoginRequestDto(phone: $phone, smsCode: $smsCode)';
}
...
class _LoginRequestDto implements LoginRequestDto {
  const _LoginRequestDto({required this.phone, required this.smsCode});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginRequestDto&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.smsCode, smsCode) || other.smsCode == smsCode));
}
