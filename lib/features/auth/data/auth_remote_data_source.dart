...
///
// TODO(auth): 端点路径按常见命名假设（auth.api.md 尚为空），契约定稿后校对。
class AuthRemoteDataSource {
  ...
  static const String _login = "/auth/login/sms";
  static const String _refreshToken = "/auth/refresh-token";
  static const String _logout = "/auth/logout";

  Future<Map<String, dynamic>> sendSmsCode(SendSmsCodeRequestDto body) =>
      _client.post<Map<String, dynamic>>(_sendSmsCode, data: body.toJson());
