...
| 全局主题令牌类 | `Happy<角色>`（不带 App） | `HappyColors`、`HappyTheme`、`HappyFonts`、`HappyTextStyles`、`HappySpacing`、`HappySemanticSpacing`、`HappyRadius`、`HappyBorderWidth`、`HappyIconSize`、`HappyControlSize`、`HappyGradients`、`HappyShadows`、`HappyMotion` |
